...
func (poolConnection *poolConnection) PoolCapabilities() (poolCapabilities.StoragepoolCapabilities, virest.Error, bool) {
	var (
	...
	storagepoolCapabilities, errorGetStoragePoolCapabilities := poolConnection.GetStoragePoolCapabilities(0)
